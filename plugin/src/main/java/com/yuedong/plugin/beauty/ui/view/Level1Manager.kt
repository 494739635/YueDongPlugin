...
import com.yuedong.plugin.beauty.ui.iLog
...
import com.yuedong.plugin.beauty.ui.adapter.BeautyAdapter
...
class Level1Manager(
    ...
    private val level1AdapterMap = ArrayMap<Int, BeautyAdapter>()

    internal fun getCurrentAdapter(): BeautyAdapter? = level1AdapterMap[currentLevel1AdapterId]
