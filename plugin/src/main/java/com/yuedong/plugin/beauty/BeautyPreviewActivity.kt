package com.yuedong.plugin.beauty
...
class BeautyPreviewActivity : AppCompatActivity() {
    ...
    private var mBubbleWindowManager: com.yuedong.plugin.beauty.ui.bubble.BubbleWindowManager? = null
    ...
    //美颜api
    private val beautyApi by lazy { com.yuedong.plugin.beauty.ui.BeautyApiUI(this) }
    ...
    private fun initView() {
        mBubbleWindowManager = com.yuedong.plugin.beauty.ui.bubble.BubbleWindowManager(this)
        ...
        mainBinding.icSetting.setOnClickListener {
            mBubbleWindowManager!!.show(mainBinding.icSetting,
                object : com.yuedong.plugin.beauty.ui.bubble.BubbleWindowManager.BubbleCallback {
    ...
    private fun initCamera() {
        ...
        sensor!!.start()
        cameraManager = CameraDisplay(
            this,
            mainBinding.surfaceView
        )
