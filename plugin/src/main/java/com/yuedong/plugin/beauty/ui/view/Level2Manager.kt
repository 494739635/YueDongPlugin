...
import com.yuedong.plugin.beauty.ui.adapter.SubBeautyAdapter
...
class Level2Manager(
    ...
    private val level2AdapterMap = ArrayMap<Int, SubBeautyAdapter>()
