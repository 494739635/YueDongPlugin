...
import com.yuedong.plugin.beauty.ui.utils.standardProgressToDataProgress

class SeekbarManager(
    private val beautySeekBar: com.yuedong.plugin.beauty.ui.view.ProgressBar,
    private val beautySeekBarTitle: TextView,
    private val filterSeekBar: com.yuedong.plugin.beauty.ui.view.ProgressBar,
    ...
    fun initSeekBar() {
        beautySeekBar.setOnProgressChangedListener(object : com.yuedong.plugin.beauty.ui.view.ProgressBar.OnProgressChangedListener {

            override fun onProgressChanged(
                progressBar: com.yuedong.plugin.beauty.ui.view.ProgressBar?, progress: Float, isFormUser: Boolean
            ) {
                if (isFormUser) {
        ...
        filterSeekBar.setOnProgressChangedListener(object : com.yuedong.plugin.beauty.ui.view.ProgressBar.OnProgressChangedListener {
            override fun onProgressChanged(
                progressBar: com.yuedong.plugin.beauty.ui.view.ProgressBar?, progress: Float, isFormUser: Boolean
            ) {
