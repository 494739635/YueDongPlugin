...
import com.yuedong.plugin.ui.view.Level2Manager
import com.yuedong.plugin.ui.view.LinkEffectManager
import com.yuedong.plugin.ui.view.ResetManager
import com.yuedong.plugin.ui.view.SeekbarManager
import com.yuedong.plugin.ui.adapter.TabAdapter
import com.yuedong.plugin.ui.model.BeautyTabData
import com.yuedong.plugin.ui.model.BeautyType
import com.yuedong.plugin.ui.model.Data
import com.yuedong.plugin.ui.model.LookupTabData
import com.yuedong.plugin.ui.model.LookupType
import com.yuedong.plugin.ui.model.MakeupData
import com.yuedong.plugin.ui.model.MakeupStyleTabData
import com.yuedong.plugin.ui.model.MakeupStyleType
import com.yuedong.plugin.ui.model.MakeupTabData
import com.yuedong.plugin.ui.model.OneKeyBeautyTabData
...
import com.yuedong.plugin.ui.model.TabId.Companion.beautyTabId
import com.yuedong.plugin.ui.model.TabId.Companion.bodyBeautyTabId
import com.yuedong.plugin.ui.model.TabId.Companion.lookupTabId
import com.yuedong.plugin.ui.model.TabId.Companion.makeupStyleTabId
import com.yuedong.plugin.ui.model.TabId.Companion.makeupTabId
import com.yuedong.plugin.ui.model.TabId.Companion.microTabId
import com.yuedong.plugin.ui.model.TabId.Companion.oneKeyBeautyTabId
import com.yuedong.plugin.ui.utils.getDataRange
...
class BeautyPanelFragment : DialogFragment() {
    ...
    private val level2Manager by lazy {
        Level2Manager(
            binding.dataRecyclerView, level1Manager.tabDataMap[makeupTabId]!!.level1List()
        )
    }
            ...
            when (tabDataList[currentTabPosition].id) {
                ...
                makeupStyleTabId -> {
                    ...
                    resetManager.resetMakeupStyle(
                        makeupStyleTabData, level1Manager.tabDataMap[makeupTabId] as MakeupTabData
                    )
    ...
    private val lipTextureMap = mapOf(
        "水润" to 1, "雾面" to 2, "镜面" to 3, "亮闪" to 4
    )
            ...
            when (it) {
                is OneKeyBeautyType -> {
                    ...
                    linkEffectManager.clearBeautyAndMicroByRenderOneKeyBeauty(
                        beautyTabData as BeautyTabData, microTabData as BeautyTabData
                    )
                }
        ...
        level1Manager.linkedEffectValueByRender = {
            when (it) {
                is OneKeyBeautyType -> {
                    ...
                    val microTabData = level1Manager.tabDataMap[microTabId]
                    linkEffectManager.changeBeautyAndMicroByRenderOneKeyBeauty(
                        it, beautyTabData as BeautyTabData, microTabData as BeautyTabData
                    )
                }
